...
///
/// ⚠️ นี่คือแหล่งความจริงเดียวของชุดแท็ก — เดิมมี 3 ชุดที่ไม่ตรงกัน
/// (mock_data.dart เก่า, ตาราง traits ในฐานข้อมูล, และไฟล์นี้) ตอนนี้เหลือชุดนี้
/// ชุดเดียว `id` แต่ละตัวต้องตรงกับ `slug` ใน backend/db/migrations/007_search_taxonomy.sql
/// เป๊ะ ๆ ถ้าจะเพิ่ม/แก้แท็ก ต้องแก้ทั้งสองที่พร้อมกัน
///
/// เมื่อ backend มี endpoint GET /traits แล้ว (ดู ROADMAP.md Phase 3.8)
/// ให้เปลี่ยนมาดึงจาก API แทนการ hardcode ไว้ที่นี่ เพื่อไม่ให้หลุดกันอีก
class PetTag {
